...
- `fieldsAttachIntersection` - Minimum intersection percentage between a field and an operation. An intersection within this value will make the operation to be linked to the given field. This property supports a floating point between 0 and 100. The default value is `0.01`. 
